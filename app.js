window.onload = () => {
  ...
  const btnPerris = document.getElementById("perris");
  btnPerris.addEventListener("click", () =>{
  obtenerDoges();
  });

  const btnGatis = document.getElementById("gatis");
  btnGatis.addEventListener("click", () =>{
  obtenerGatos();
  });

  const btnPajaris = document.getElementById("pajaris");
  btnPajaris.addEventListener("click", () =>{
  dogesYCatesEnParalelo();
  });
